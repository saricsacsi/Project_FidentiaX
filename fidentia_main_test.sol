...
contract FidentiaXTokenSale is Ownable {
  ...
  address firstContractor = 0x00158EB87544629DD72130a9Ab504d4Bf83BFf68; // test1
  address secondContractor = 0x007Fc4D05C2e2440fd2616edebDED61aD94a607D; // test2A
  ...
  function FidentiaXTokenSale() public {
    startTimestamp = 1508684400; // test time!!!
    // 1509930000 Monday November 06, 2017 09:00:00 (am) in time zone Asia/Singapore (SGT)
    //1508684400 test time
    ...
    multiSig = 0xCD1d44dBdBFdc24C6E25E53282727557a7142f1D; // test multisig1
