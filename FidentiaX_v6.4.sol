...
contract FidentiaXTokenSale is Ownable {
  ...
  uint256 public tokensForSale;  // .. Million Tokens for SALE
  ...
  // switch on/off the authorisation , if its false :  authorisation is needed
  ...
  function FidentiaXTokenSale() public {
    ...
    tokensForSale = 130 * (10**6) * oneCoin;  // this  is the Cap if we need
  }
  ...
  */
  ...
  /**
  * @dev throws if person sending is not contract owner or cs or Fx role
   */
  modifier onlyCSorFx() {
